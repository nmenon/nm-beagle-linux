...
#define CC33XX_TRACE_LOSS_GAPS_TX 10
#define CC33XX_TRACE_LOSS_GAPS_RX 18		
...
struct cc33xx_mac_and_phy_params {
	u8 phy_standalone;
	u8 spare0;
	u8 enable_clpc;
	...
	s8 med_power_val;
	s8 high_power_val;
	s8 per_sub_band_tx_trace_loss[CC33XX_TRACE_LOSS_GAPS_TX];
	s8 per_sub_band_rx_trace_loss[CC33XX_TRACE_LOSS_GAPS_RX];
	u8 tx_rf_margin;
...
struct wlcore_conf {
	...
	struct cc33xx_mac_and_phy_params phy;
